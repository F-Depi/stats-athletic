...
def extract_meet_codes_from_calendar(anno, mese, livello, regione, tipo, categoria):
    ...
    ## Per ogni gara presente nel calendario della fidal https://www.fidal.it/calendario.php scarica
    ## codice gara, data, nome, home page della gara
...
def get_meet_info(df_gare, update_criteria):
    ...
    ## Input: DataFrame con columns=[Data','Codice','Nome','Home Gara','Home','Risultati','Versione Sigma','Status','Ultimo Aggiornamento']
    ## Output: DataFrame con columns=[Data','Codice','Nome','Home Gara','Home','Risultati','Versione Sigma','Status','Ultimo Aggiornamento']
    ## 'Data' e 'Ultimo Aggiornamento' devono essere riconosciuti da python come date() formato YYYY-MM-DD
    ##
    ## Trova i link da mettere nelle colonne 'Home', 'Risultati'
...
def get_events_link(df_gare, update_criteria, *arg):
    ...
    ## input: dataframe con columns=['data','codice','home','risultati','versione sigma','status','ultimo aggiornamento']
    ## output: dataframe con columns=['codice','versione sigma','warining','disciplina','nome','link']
    ## dato il link alla pagina di risultati di una competizione (es. https://www.fidal.it/risultati/2024/REG33841/Risultati/IndexRisultatiPerGara.html)
    ## cerca i link ai risultati di ogni disciplina presente in quella pagina. Salva anche il nome con cui compare quella disciplina.
